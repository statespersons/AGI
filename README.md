...
- [`memory/`](memory/) — wiki-style knowledge base
  - [`essay-what-am-i.md`](memory/essay-what-am-i.md) — full synthesis essay
  - [`project-what-am-i.md`](memory/project-what-am-i.md) — research notes
  - [`budget-tracking.md`](memory/budget-tracking.md) — session costs
